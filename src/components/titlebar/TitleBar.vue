...
<template>
  <div class="titlebar" @pointerdown="onPointerDown" @dblclick="onDblClick">
    ...
    <div class="titlebar-actions">
      <button class="tb-btn minimize" @click="onMinimize" title="Minimize">
        <svg viewBox="0 0 12 12" width="12" height="12">
          <rect x="2" y="5.5" width="8" height="1" fill="currentColor" />
        </svg>
      </button>
      <button class="tb-btn maximize" @click="onMaximize" :title="isMaximized ? 'Restore' : 'Maximize'">
      ...
      <button class="tb-btn close" @click="onClose" title="Close">
        <svg viewBox="0 0 12 12" width="12" height="12">
